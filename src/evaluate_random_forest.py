...
MODEL_DIR = "../results/models_classical/random_forest"
...
def main():
    ...
    print("========================================")
    print(f"Random Forest - config migliore: {best_config_name}")
    print(f"  n_estimators={best_config['n_estimators']}, max_depth={best_config['max_depth']}, "
          f"min_samples_leaf={best_config['min_samples_leaf']}, class_weight={best_config['class_weight']}")
