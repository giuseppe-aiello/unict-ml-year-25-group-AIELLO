...
def main():
    ...
    print("========================================")
    print(f"AdaBoost - config migliore: {best_config_name}")
    print(f"  n_estimators={best_config['n_estimators']}, learning_rate={best_config['learning_rate']}, "
          f"base_class_weight={best_config['base_class_weight']}")
